...
func InferencePoolMustHaveCondition(t *testing.T, c client.Client, gatewayTimeoutConfig gatewayconfig.TimeoutConfig, poolNN types.NamespacedName, expectedCondition metav1.Condition) {
	t.Helper() // Marks this function as a test helper

	var timeoutConfig config.InferenceExtensionTimeoutConfig = config.NewInferenceExtensionTimeoutConfigFromGatewayConfig(gatewayTimeoutConfig)
